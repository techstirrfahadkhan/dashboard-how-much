const PrivacyPolicy = () => {
	return (
		<div style={{ padding: '1rem' }}>
			...
			<ol>
				<p>
					How Much built the How Much app as a Free app. This SERVICE is
					provided by How Much at no cost and is intended for use as is. This
					...
					Conditions, which are accessible at How Much unless otherwise defined
					...
					<ul>
						...
						<p>
							...
							<ul>
								...
								<li>
									{' '}
									or To assist use in analyzing how our Service is used reasons
								</li>
							</ul>
